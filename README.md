...
1. Run this command:
	...
	```bash
	cd /tmp; wget --no-check-certificate -O ISPConfig3.tgz https://github.com/kuasha420/ISPConfig-3-Debian-Installer/tarball/master; tar zxvf ISPConfig3.tgz; cd *Installer*; bash debian_install.sh
	```
...
1. Run this command:
	...
	```bash
	cd /tmp; wget --no-check-certificate -O ISPConfig3.tgz https://github.com/kuasha420/ISPConfig-3-Debian-Installer/tarball/master; tar zxvf ISPConfig3.tgz; cd *Installer*; bash ubuntu_install.sh
	```
2. Answer the onscreen prompts. The script stops so that you can see the appropriate answers.
3. Enjoy the completed installation.
...
2. Run this command:
	...
	```bash
	cd /tmp; wget --no-check-certificate -O ISPConfig3.tgz https://github.com/kuasha420/ISPConfig-3-Debian-Installer/tarball/master; tar zxvf ISPConfig3.tgz; cd *Installer*; bash roundcube_install.sh
	```
